...
* Servicio que provee la implementaci—n de los mÌ©todos 
...
public class BenefitsService implements BenefitsServiceInterface {
	...
	/**
	  * Retorna a travÌ©s del repositorio el ejb del beneficio.
	  * 
	...
	/**
	  * Retorna a travÌ©s del repositorio una lista de 
	  * ejbs de beneficios.
	  * 
