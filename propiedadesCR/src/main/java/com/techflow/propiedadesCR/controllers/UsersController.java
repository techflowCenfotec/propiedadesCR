...
public class UsersController {
	...
	/** 
     * Este objeto mantiene la sesi√≥n en el backend
     */
	@Autowired private HttpServletRequest httpServletRequest;
	
	/**
†  * Este m√©todo retorna todos los usuarios registrados en el sistema
    *
†  * @param puserResponse Este par√°metro encapsula la informaci√≥n solicitada en el metodo.
	*
...
†  */
	...
	public UsersResponse getAll(@RequestBody UsersRequest puserRequest) {
	  ...
	  /**
	†* Este m√©todo registra un usuario en el sistema.
	  *
	...
	†* @param puserName Nombre de usuario.
      ...
      * @param pphone1 Tel√©fono del usuario.
      * @param pphone2 Tel√©fono alternativo del usuario.
      * @param pemail Correo del usuario.
      * @param ppassword Contrase√±a del usaurio.
      * 
	¬†¬†* @return userResponse Retorna la respuesta del servicio hacia el frontend.
	¬†¬†*
	  * @throws ParseException Esta exepci√≥n se lanza cuando el sistema es incapaz de transformar
	...
	/**
†  * Este m√©todo retorna el usuario loggeado en la aplicaci√≥n
    *
  ††* @return response Retorna la respuesta del sevicio hacia el frontend.
†  */
		...
		/**
	†  * Este m√©todo retorna el usuario que se desea consultar
		*
	...
	†  */			
		...
		public UsersResponse modifyUser(@RequestParam("file") MultipartFile pfile,
			...
			return userResponse;		
					...
					/**
		  * Env√≠a la informaci√≥n a agregar a la base de datos por medio de su servicio. 
		  * 
		  * @param pProperty Ejb que contiene la informaci√≥n de la entidad que
		  * se desea crear.
